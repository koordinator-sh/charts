...
| `manager.image.tag`                       | Tag for koord-manager image                                      | `v1.4.1`                        |
...
| `scheduler.image.tag`                     | Tag for koord-scheduler image                                    | `v1.4.1`                        |
...
| `koordlet.image.tag`                      | Tag for koordlet image                                           | `v1.4.1`                        |
