...
| `manager.image.tag`                       | Tag for koord-manager image                                      | `v0.6.2`                        |
...
| `scheduler.image.tag`                     | Tag for koord-scheduler image                                    | `v0.6.2`                        |
...
| `koordlet.image.tag`                      | Tag for koordlet image                                           | `v0.6.2`                        |
