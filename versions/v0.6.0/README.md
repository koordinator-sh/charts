...
| `manager.image.tag`                       | Tag for koord-manager image                                      | `v0.6.0`                        |
...
| `scheduler.image.tag`                     | Tag for koord-scheduler image                                    | `v0.6.0`                        |
...
| `koordlet.image.tag`                      | Tag for koordlet image                                           | `v0.6.0`                        |
