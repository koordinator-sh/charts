...
| `manager.image.tag`                       | Tag for koord-manager image                                      | `v0.3.1`                        |
...
| `scheduler.image.tag`                     | Tag for koord-scheduler image                                    | `v0.3.1`                        |
...
| `koordlet.image.tag`                      | Tag for koordlet image                                           | `v0.3.1`                        |
